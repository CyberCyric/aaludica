  ...
  return (
    <div className="col-xl-4 col-md-6 mb-5">
      <div className="template_card d-flex flex-column">
        ...
        <div className="subtitleproducts" align="center">
          {props.product.subname}
        </div>        
        ...
        <div className="row">
          ...
          <div className="col-md-6 columnader">
            ...
            &nbsp;*/}
              <button
                ...
                id={"btn-buy-" + props.product.id}
                onClick={handleAddItem}
              >
                <span className="buy_label">
                  agregar al{" "}
                  <span className="icocart">
                    {" "}
                    <HiShoppingCart />
                  </span>
                </span>
